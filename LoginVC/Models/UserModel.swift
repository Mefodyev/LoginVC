...
2020 - по наст. время: Работа техническим аналитиком в компании ООО "КРОК"

Начиная с начала 2020 г. интересуюсь iOS разработкой, имею желание работать на начальной позиции или пройти стажировку в любом направлении, связанной с iOS разработкой. Перейдя по кнопке ниже вы сможете просмотреть актуальные примеры кода.
""")
